...
//* just want jwt to give me id , every thing will be done by me
//* to write common part of fetching jwt to get id must be written in middleware
//* middleware, (req, res, next) in this next we run async (req, res) of /getUser
//* thunderclient, pass auth-token generate by login user in header section
